...
cart.forEach((cartIteam) => {
    ...
    const deliveryOptionId = cartIteam.deliveryOptionId;
    ...
    js-cart-item-container-${matchingProduct.id}">
        ...
        <div class="cart-item-details">
            ...
            $${formatCurranecy(matchingProduct.priceCents)}
            </div>
            <div class="product-quantity">
            <span>
                Quantity: <span class="quantity-label js-quantity-label-${matchingProduct.id}">${cartIteam.quantity}</span>
            </span>
        ...
        <div class="delivery-options">
           ...
           ${deliveryOptionsHTML(matchingProduct , cartIteam)}
        </div>
        </div>
    </div>` ;
});
function deliveryOptionsHTML(matchingProduct ,cartIteam){
    let HTML = '';
    deliveryOptions.forEach((deliveryOption) => {
        ...
        === 0
        ? 'FREE'
        : `$${ formatCurranecy(deliveryOption.priceCents)} -`;
